    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(). 'C_Paket/tambah_aksi'; ?>" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="paket">Paket</label>
                  <input type="text" class="form-control" name="paket" id="paket" placeholder="Masukkan Paket">
                </div>
                <div class="form-group">
